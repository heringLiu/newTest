package com.management.staff.demo.config.swagger;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
                .apis(RequestHandlerSelectors.basePackage("com.management.staff.demo.controller")).paths(PathSelectors.any())
    ...
    private List<Parameter> setHeaderToken() {
        ...
        userId.name("token").description("").modelRef(new ModelRef("string")).parameterType("header")
                .required(true).build();
